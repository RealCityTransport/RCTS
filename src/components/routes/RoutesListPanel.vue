<!-- src/components/routes/RoutesListPanel.vue -->
<template>
...
.route-status[data-status='설계중'] {
  border-color: rgba(148, 163, 184, 0.9);
}

.route-status[data-status='건설중'] {
  border-color: rgba(96, 165, 250, 0.9);
}
